...
impl<R: Remoting + Clone> traits::RouterVaraDexFactory for RouterVaraDexFactory<R> {
    ...
    fn new(
        ...
        RemotingAction::<_, router_vara_dex_factory::io::New>::new(
            self.remoting.clone(),
            (factory, wvara, admin_addr, fund_addr, swap_fee_bps),
        )
    }
}
...
pub mod router_vara_dex_factory {
    ...
    pub mod io {
        ...
        impl ActionIo for New {
            ...
            type Params = (ActorId, ActorId, ActorId, ActorId, u128);
            type Reply = ();
        }
    }
}
...
impl<R: Remoting + Clone> traits::RouterService for RouterService<R> {
    ...
    fn recover_pending_liquidity(
        ...
        RemotingAction::<_, router_service::io::RecoverPendingLiquidity>::new(
            self.remoting.clone(),
            user,
        )
    }
    fn refund_token(
        ...
        token_addr: ActorId,
        amount: U256,
    ) -> impl Call<Output = Result<bool, RouterError>, Args = R::Args> {
        RemotingAction::<_, router_service::io::RefundToken>::new(
            self.remoting.clone(),
            (token_addr, amount),
        )
    }
    fn refund_vara(
        ...
        RemotingAction::<_, router_service::io::RefundVara>::new(self.remoting.clone(), amount)
    }
    fn remove_liquidity(
        &mut self,
        token_a: ActorId,
    ...
    fn skim_pair_liquidity(
        &mut self,
        pair: ActorId,
    ) -> impl Call<Output = Result<(), RouterError>, Args = R::Args> {
        RemotingAction::<_, router_service::io::SkimPairLiquidity>::new(self.remoting.clone(), pair)
    }
    ...
    fn update_fund_addr(
        ...
        RemotingAction::<_, router_service::io::UpdateFundAddr>::new(
            self.remoting.clone(),
            new_fund_addr,
        )
    }
    fn update_new_admin(
        ...
        RemotingAction::<_, router_service::io::UpdateNewAdmin>::new(
            self.remoting.clone(),
            new_addr,
        )
    }
    fn update_new_factorty(
        &mut self,
        new_factory_addr: ActorId,
    ) -> impl Call<Output = Result<bool, RouterError>, Args = R::Args> {
        RemotingAction::<_, router_service::io::UpdateNewFactorty>::new(
            self.remoting.clone(),
            new_factory_addr,
        )
    }
    fn update_new_wrapvara(
        &mut self,
        new_wvara_addr: ActorId,
    ) -> impl Call<Output = Result<bool, RouterError>, Args = R::Args> {
        RemotingAction::<_, router_service::io::UpdateNewWrapvara>::new(
            self.remoting.clone(),
            new_wvara_addr,
        )
    }
    fn update_swap_fee_bps(
        &mut self,
        new_swap_fee_bps: u128,
    ) -> impl Call<Output = Result<bool, RouterError>, Args = R::Args> {
        RemotingAction::<_, router_service::io::UpdateSwapFeeBps>::new(
            self.remoting.clone(),
            new_swap_fee_bps,
        )
    }
...
pub mod router_service {
    ...
    pub mod io {
        ...
        impl RecoverPendingLiquidity {
            #[allow(dead_code)]
            pub fn encode_call(user: ActorId) -> Vec<u8> {
                <RecoverPendingLiquidity as ActionIo>::encode_call(&user)
            }
        }
        impl ActionIo for RecoverPendingLiquidity {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 92, 82, 101, 99,
                111, 118, 101, 114, 80, 101, 110, 100, 105, 110, 103, 76, 105, 113, 117, 105, 100,
                105, 116, 121,
            ];
            type Params = ActorId;
            type Reply = Result<(), super::RouterError>;
        ...
        impl RefundToken {
            #[allow(dead_code)]
            pub fn encode_call(token_addr: ActorId, amount: U256) -> Vec<u8> {
                <RefundToken as ActionIo>::encode_call(&(token_addr, amount))
            }
        }
        impl ActionIo for RefundToken {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 44, 82, 101, 102,
                117, 110, 100, 84, 111, 107, 101, 110,
            ];
            type Params = (ActorId, U256);
            type Reply = Result<bool, super::RouterError>;
        }
        pub struct RefundVara(());
        impl RefundVara {
            #[allow(dead_code)]
            pub fn encode_call(amount: u128) -> Vec<u8> {
                <RefundVara as ActionIo>::encode_call(&amount)
            }
        }
        impl ActionIo for RefundVara {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 40, 82, 101, 102,
                117, 110, 100, 86, 97, 114, 97,
            ];
            type Params = u128;
            type Reply = Result<bool, super::RouterError>;
        }
        ...
        pub struct SkimPairLiquidity(());
        impl SkimPairLiquidity {
            #[allow(dead_code)]
            pub fn encode_call(pair: ActorId) -> Vec<u8> {
                <SkimPairLiquidity as ActionIo>::encode_call(&pair)
            }
        }
        impl ActionIo for SkimPairLiquidity {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 68, 83, 107, 105,
                109, 80, 97, 105, 114, 76, 105, 113, 117, 105, 100, 105, 116, 121,
            ];
            type Params = ActorId;
            type Reply = Result<(), super::RouterError>;
        }
        ...
        impl UpdateFundAddr {
            #[allow(dead_code)]
            pub fn encode_call(new_fund_addr: ActorId) -> Vec<u8> {
                <UpdateFundAddr as ActionIo>::encode_call(&new_fund_addr)
            }
        }
        impl ActionIo for UpdateFundAddr {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 56, 85, 112, 100,
                97, 116, 101, 70, 117, 110, 100, 65, 100, 100, 114,
            ];
            type Params = ActorId;
            type Reply = Result<bool, super::RouterError>;
        }
        pub struct UpdateNewAdmin(());
        impl UpdateNewAdmin {
            #[allow(dead_code)]
            pub fn encode_call(new_addr: ActorId) -> Vec<u8> {
                <UpdateNewAdmin as ActionIo>::encode_call(&new_addr)
            }
        }
        impl ActionIo for UpdateNewAdmin {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 56, 85, 112, 100,
                97, 116, 101, 78, 101, 119, 65, 100, 109, 105, 110,
            ];
            type Params = ActorId;
            type Reply = Result<bool, super::RouterError>;
        }
        pub struct UpdateNewFactorty(());
        impl UpdateNewFactorty {
            #[allow(dead_code)]
            pub fn encode_call(new_factory_addr: ActorId) -> Vec<u8> {
                <UpdateNewFactorty as ActionIo>::encode_call(&new_factory_addr)
            }
        }
        impl ActionIo for UpdateNewFactorty {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 68, 85, 112, 100,
                97, 116, 101, 78, 101, 119, 70, 97, 99, 116, 111, 114, 116, 121,
            ];
            type Params = ActorId;
            type Reply = Result<bool, super::RouterError>;
        }
        pub struct UpdateNewWrapvara(());
        impl UpdateNewWrapvara {
            #[allow(dead_code)]
            pub fn encode_call(new_wvara_addr: ActorId) -> Vec<u8> {
                <UpdateNewWrapvara as ActionIo>::encode_call(&new_wvara_addr)
            }
        }
        impl ActionIo for UpdateNewWrapvara {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 68, 85, 112, 100,
                97, 116, 101, 78, 101, 119, 87, 114, 97, 112, 118, 97, 114, 97,
            ];
            type Params = ActorId;
            type Reply = Result<bool, super::RouterError>;
        }
        pub struct UpdateSwapFeeBps(());
        impl UpdateSwapFeeBps {
            #[allow(dead_code)]
            pub fn encode_call(new_swap_fee_bps: u128) -> Vec<u8> {
                <UpdateSwapFeeBps as ActionIo>::encode_call(&new_swap_fee_bps)
            }
        }
        impl ActionIo for UpdateSwapFeeBps {
            const ROUTE: &'static [u8] = &[
                52, 82, 111, 117, 116, 101, 114, 83, 101, 114, 118, 105, 99, 101, 64, 85, 112, 100,
                97, 116, 101, 83, 119, 97, 112, 70, 101, 101, 66, 112, 115,
            ];
            type Params = u128;
            type Reply = Result<bool, super::RouterError>;
        }
